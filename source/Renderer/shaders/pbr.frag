...
void main()
{
    ...
    for (int i = 0; i < LIGHT_COUNT; ++i)
    {
        ...
        vec3 l_color = getSubsurfaceScattering(v_Position, u_ProjectionMatrix, materialInfo.attenuationDistance * materialInfo.attenuationColor, u_ScatterFramebufferSampler, materialInfo.diffuseTransmissionColorFactor, materialInfo.multiscatterColor, singleScatter);
